...
logging.basicConfig(level=logging.INFO,
                    ...
                    filename=os.path.join("src_zh", "classification", "classifications_zh_nano.log"),
                    filemode='w')
...
def get_classifications(BASE_DIR: str = "annual_zh/annual_txts_zh/China", model_name:str = "gpt-4.1-nano"):
    """
    ...
    for filtered_output in tqdm(filtered_outputs):
        save_path = filtered_output.replace("filtered.json", "classifications_nano.json")
...
if __name__ == '__main__':
    get_classifications("annual_zh/annual_txts_zh/China", "gpt-4.1-nano")
