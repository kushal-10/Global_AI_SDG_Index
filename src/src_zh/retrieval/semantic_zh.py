...
logging.basicConfig(level=logging.INFO,
                    ...
                    filename=os.path.join("src_zh", "retrieval_legacy", "semantic_zh.log"),
                    filemode='w')
...
def get_classifications(BASE_DIR: str = "annual_zh/annual_txts_zh", save_name: str = "semantic.json"):
    """
