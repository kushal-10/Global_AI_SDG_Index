...
logging.basicConfig(
    ...
    level=logging.INFO,
    filemode="w",
    filename=os.path.join("src", "retrievalv2", "regex.log"))
...
def extract_ai_passages(input_dir: str):
    """
    ...
    for report_path in tqdm(reports, desc="Processing reports"):
        ...
        if matched:
            ...
            save_path = report_path.replace("results.txt", "regex_output.json")
...
if __name__ == "__main__":
    ...
    extract_ai_passages(input_dir=BASE_DIR)
